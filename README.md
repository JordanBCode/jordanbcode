...
- ⚙️ Hands-on PowerShell experience across Microsoft 365, Exchange Online, 
  and Windows endpoint administration
...
`Exchange Online` `Microsoft 365` `PowerShell` `VirusTotal`
